Title: Как я создаю приложения, работающие везде и всегда
...
Последняя версия редактора доступна здесь: [http://gitjs.org/📦](http://gitjs.org/📦)

Первый пуск происходит не быстро, так что наберитесь терпения.

# Приложение GitJS №2: пасьянс Маджонг

Игра на текущий момент обладает следующей функциональностью:

1. выбор и удаление фишек с поля в соответствии с правилами пасьянса Маджонг
    * ![][механика]
1. выбор темы фишек
    * ![][темы]
1. выбор раскладки игрового поля
    * ![][раскладки]
1. определение победы и поражения

Конечной целью для игры является воспроизведение выпущенного много лет назад
[Маджонга][маджонг1], который работал лишь на Linux и Windows. Текущая
доступность новой игры по ссылке на любом устройстве сильно воодушевляет.
...
[снимок]: ../../images/2021_gitjs-intro_снимок.png
